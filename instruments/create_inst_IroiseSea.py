...
# Define across_range for interpolation
...
## create interpolation function based on across_distance
f_inc_sqt = interpolate.interp1d(
        across_distance_propa, inc_angle_sqt_propa,
        fill_value='extrapolate')
f_squint_ground = interpolate.interp1d(
        across_distance_propa, sqt_ground_propa,
        fill_value='extrapolate')
f_broadside = interpolate.interp1d(
        across_distance_propa,  inc_angle_broadside_propa, 
        fill_value='extrapolate')
#f_across = interpolate.interp1d(
#        inc_angle_broadside_propa, across_distance_propa,
#        fill_value='extrapolate')
# interpolation over defined across distance
inc_angle_mid = f_broadside(across)
inc_angle_sqt = f_inc_sqt(across)
squint_ground = f_squint_ground(across)
#across = f_across(inc_angle_broadside)
squint_ground_heading = f_squint_ground(across)

inc_angle_broadside = inc_angle_mid
